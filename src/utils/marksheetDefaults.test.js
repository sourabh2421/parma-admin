...
describe('marksheetDefaults utils', () => {
  it('has default main subjects configured for all class entries', () => {
    ...
    expect(DEFAULT_CLASS_SUBJECTS['I']).toEqual(['English-I', 'English-II', 'Hindi', 'Maths', 'E.V.S.', 'G.K.', 'Computer', 'Drawing'])
    expect(DEFAULT_CLASS_SUBJECTS['III']).toEqual(['English-I', 'English-II', 'Hindi', 'Maths', 'Science', 'Social Studies', 'Sanskrit', 'G.K.', 'Computer', 'Drawing'])
    expect(DEFAULT_CLASS_SUBJECTS['V']).toEqual(['English-I', 'English-II', 'Hindi', 'Maths', 'Science', 'Social Studies', 'Sanskrit', 'G.K.', 'Computer', 'Drawing'])
    expect(DEFAULT_CLASS_SUBJECTS['IX']).toEqual(['English-I', 'English-II', 'Hindi', 'Maths', 'Physics', 'Chemistry', 'Biology', 'History & Civics', 'Geography', 'Physical Education'])
    expect(DEFAULT_CLASS_SUBJECTS['XI Science']).toEqual(['English-I', 'English-II', 'Physics', 'Chemistry', 'Maths', 'Biology', 'Physical Education'])
    expect(DEFAULT_CLASS_SUBJECTS['XI Commerce']).toEqual(['English-I', 'English-II', 'Hindi', 'Accounts', 'Commerce', 'Economics', 'Physical Education'])
    expect(DEFAULT_CLASS_SUBJECTS['XI Humanities']).toEqual(['English-I', 'English-II', 'Hindi', 'History & Civics', 'Political Science', 'Economics', 'Physical Education'])
    expect(DEFAULT_CLASS_SUBJECTS['XII Humanities']).toEqual(['English-I', 'English-II', 'Hindi', 'History & Civics', 'Political Science', 'Economics', 'Physical Education'])
  })
